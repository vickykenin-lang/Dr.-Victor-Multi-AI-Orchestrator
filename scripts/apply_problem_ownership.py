...
# Idempotence: later integration scripts may insert fact classification between ownedProblem and hulkRequest.
if "const ownedProblem = classifyOwnedProblem(text, sessionWithFounderTurn);" not in text:
...
if "mode: ownedProblem.mode" not in text:
