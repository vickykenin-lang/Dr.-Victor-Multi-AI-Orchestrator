...
import { classifyFounderIntent as classifyV2FounderIntent, FOUNDER_INTENT as V2_FOUNDER_INTENT } from '../brain/founder_intent_gateway.mjs';
...
export default {
  ...
  async fetch(request, env, ctx) {
    ...
    try {
      ...
      if (v2Intent.intent === V2_FOUNDER_INTENT.EXECUTION_COMMAND && shouldRunDeadEndRecovery(memoryDirective, explicitExecutiveGoalCommand, deadEnd)) {
...
${JSON.stringify(semanticResults)}`,
      ...
      if (!memoryDirective && v2Intent.intent === V2_FOUNDER_INTENT.EXECUTION_COMMAND && shouldExecuteCrossDepartment(founderRequest.execution_plan)) {
      ...
      if (!memoryDirective && v2Intent.intent === V2_FOUNDER_INTENT.EXECUTION_COMMAND && ownedProblem.matched) {
      ...
      if (!memoryDirective && v2Intent.intent === V2_FOUNDER_INTENT.EXECUTION_COMMAND && contextualFollowUp.mode === 'CONTEXTUAL_INVESTIGATION') {
